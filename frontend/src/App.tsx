...
function App() {
  ...
  return (
    <div className="min-h-screen flex flex-col py-12 px-4">
      ...
      <footer className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-6 text-sm text-gray-600 dark:text-gray-300 text-center">
        <div className="max-w-7xl mx-auto flex flex-col gap-2">
          ...
          <p>
            ...
            <a
              className="underline font-semibold"
              href="https://github.com/breadoliveoilsalt/jlox-compiler-in-ts"
              target="_blank"
              rel="noreferrer"
            >
